...
public static class ModelBuilderExtensions
{
    public static void Seed(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<RaceClass>().HasData(
            ...
            new RaceClass { Id = RaceClassId.EliteStakes, Name = "Grade II", Description = "Second highest graded stakes races" },
            new RaceClass { Id = RaceClassId.Championship, Name = "Grade I", Description = "Highest graded championship races" }
        );
        ...
        modelBuilder.Entity<Race>().HasData(
            ...
            new Race { Id = 28, Name = "Emerald Turf Cup", Description = "Twelve-furlong turf crown - staying classic on grass", SurfaceId = SurfaceId.Turf, TrackId = (TrackId)4, Furlongs = 12, RaceClassId = RaceClassId.Championship, MinFieldSize = 10, MaxFieldSize = 20, Purse = 1100000 },
            new Race { Id = 29, Name = "Golden Gate Derby", Description = "Three-year-old classic - a season-defining dirt crown", SurfaceId = SurfaceId.Dirt, TrackId = (TrackId)5, Furlongs = 10, RaceClassId = RaceClassId.Championship, MinFieldSize = 10, MaxFieldSize = 20, Purse = 1000000 },
            new Race { Id = 30, Name = "Founders Oaks", Description = "Fillies classic - the Oaks crown for the division", SurfaceId = SurfaceId.Dirt, TrackId = (TrackId)6, Furlongs = 9, RaceClassId = RaceClassId.Championship, MinFieldSize = 10, MaxFieldSize = 20, Purse = 1000000 }
        );
