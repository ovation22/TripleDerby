...
/// <summary>
/// Tests for GenericMessageConsumer (Phase 3)
/// </summary>
public class GenericMessageConsumerTests
{
    ...
    public void Constructor_CreatesInstance()
    {
        ...
        var consumer = new GenericMessageConsumer<TestMessage, IMessageProcessor<TestMessage>>(
            ...
            _configuration,
            scopeFactory,
            NullLogger<GenericMessageConsumer<TestMessage, IMessageProcessor<TestMessage>>>.Instance);
    ...
    public void Constructor_ImplementsIMessageConsumer()
    {
        ...
        // Assert
        Assert.IsAssignableFrom<IMessageConsumer>(consumer);
    }
