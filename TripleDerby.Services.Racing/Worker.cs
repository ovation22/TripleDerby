...
public class Worker(ILogger<Worker> logger, IMessageConsumer consumer) : BackgroundService
{
    ...
    {
        _logger.LogInformation("Racing Worker starting message consumer.");
        ...
        {
            _logger.LogInformation("Racing Worker stopping message consumer.");
            ...
            _logger.LogInformation("Racing Worker stopped.");
        }
    }
}
